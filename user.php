  ...
  <body>
    <div class="container-fluid h-100">
      ...
      <?php
        ...
        $sql = "SELECT sheetmusic_id, title, composer, genre, timestamp FROM sheetmusic WHERE user_id = {$user_id}";
        ...
        while($row = $result->fetch_assoc())
        {
          ...
          echo "<tr>";
          echo "<td><a href='./music.php?sheetmusic_id={$sheetmusic_id}'>{$title}</a></td><td>".$composer."</td><td>".$genre."</td><td>".$timestamp."</td>";
          echo "<tr>";
        }
        echo "</table>";
    ?>
